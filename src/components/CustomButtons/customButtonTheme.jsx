   ...
   components: {
      MyButtonComponent: {
         ...
         variants: [
            ...
            {
               props: { color: 'success', size: 'large' },
            },
            {
            ...
            {
               props: { color: 'warning', size: 'large' },
            },
            {
            ...
            {
               props: { color: 'danger', size: 'large' },
            },
            {
               props: { color: 'danger', size: 'small' },
            },
            {
               props: { color: 'rose' },
            },
            {
               props: { color: 'rose', size: 'large' },
            },
            {
               props: { color: 'rose', size: 'small' },
            },
            {
               props: { color: 'white' },
            },
            ...
            {
               props: { color: 'transparent', size: 'large' },
            },
            {
               props: { color: 'transparent', size: 'small' },
            },
         ],
      },
   },
